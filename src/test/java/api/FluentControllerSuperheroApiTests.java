...
//        String expectedId = fluentSuperheroController.createSuperhero(SUPERHERO_WITHOUT_PHONE)
//                .statusCodeIs(200)
//                .getJsonValue("id");

        fluentSuperheroController.createSuperhero(SUPERHERO_WITHOUT_PHONE)
                .statusCodeIs(200);

        Thread.sleep(3000);
        fluentSuperheroController.getSuperheroesById(SUPERHERO_WITHOUT_PHONE.getId())
                .statusCodeIs(200)
                ...
                .jsonValueIs("id", String.valueOf(SUPERHERO_WITHOUT_PHONE.getId()))
    ...
    void checkGetSuperheroByIdTest() {
        fluentSuperheroController.getSuperheroesById(10).statusCodeIs(200);
    }

    @Test
    @DisplayName("Check update superhero by id")
    void checkUpdateSuperheroByIdTest() {
        fluentSuperheroController.updateSuperhero(UPDATE_SUPERHERO, 200).statusCodeIs(400);
    }
